    ...
    <main id="contents">
        ...
        <section id="board-type" class="section center mb100">
            <div class="board-container">
                ...
                <p class="section__desc">자유롭게 소통하는 공간입니다.</p>
                <div class="board__inner">
                    <div class="boardView__table">
                        <table>
                            <colgroup>
                                <col style="width: 30%">
                                <col style="width: 70%">
...
<?php
    ...
    $sql = "SELECT b.boardTitle, m.youName, b.regTime, b.boardView, b.boardContents FROM freeBoard b JOIN myMember m ON(m.memberID = b.memberID) WHERE b.boardID = {$boardID}";
    $result = $connect -> query($sql);

    $sql = "UPDATE freeBoard SET boardView = boardView + 1 WHERE boardID = {$boardID}";
    $connect -> query($sql);
...
if($result){
    if ($boardInfo['youName'] == $_SESSION['youName']){
        echo '<a href="freeBoardRemove.php?boardID='.$boardID.'" onclick="return noticeRemove();" style="margin-right:5px;">삭제하기</a>';
